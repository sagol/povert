...
def predict():
    ...
    data_B.load(load=True)
    data_C.load(load=True)
    ...
    process_xgb = process.processing(countries=['A', 'B', 'C'], balances=balances)
    ...
    #exclude_XGB_dict = process_xgb.exclude_dict
    ...
    process_cb = process.processing(countries=['A','B','C'], balances=balances)
    ...
    submission['poor'] = result_xgb['poor']*0.4 + result_cb['poor']*0.4 + result_lgbm['poor']*0.2
